...
% Set different output options
 for indm=1:nmodes
    ...
    case 'annual'
        ...
        output.annual.var_name = {'dfish','dharvest','effort', ... % effort_month
                                  'dfish','dharvest','effort', ... % effort_month
                                  'dfish','dharvest','effort', ... % effort_month
                                  'dfish','dharvest','effort', ... % effort_month
                                  'effort_change_y', 'harvest_change_y'};    % OUTPUT ADDED BY KIM
...
%                                  'gi','gi','gi'};        
        ...
        output.annual.var_outn = {'fish_g_out','harvest_g_out','effort_g_out', ...
                                  ...
                                  'fish_gi_g','harvest_gi_g','effort_gi_g', ... % shouldn't these be named fish_2di_g... ?
                                  'fish_gi_t','harvest_gi_t','effort_gi_t', ... % shouldn't these be named fish_2di_t... ?
                                  'effort_change_yr', 'harvest_change_yr'};  % OUTPUT ADDED BY KIM
